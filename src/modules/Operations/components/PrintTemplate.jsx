...
const PrintTemplate = ({ 
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', width: '100%' }}>
        ...
        <div style={{ width: '160px', display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
          <img 
            ...
            onError={(e) => { e.target.src = '/logo_new.png'; }}
          /></div>
  ...
  const Footer = () => (
    <div className="print-footer-content" style={{ width: '100%', marginTop: '40px', fontFamily: "'Cambria', Georgia, serif" }}>
      ...
      <div style={{ borderTop: '1.5px solid #cbd5e1', paddingTop: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '8.5pt', color: '#475569', lineHeight: '1.5' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', textAlign: 'left', flex: 1, paddingRight: '15px' }}>
          <img src="/logo_new.png" alt="Company Logo" style={{ height: '22px', objectFit: 'contain' }} onError={(e) => { e.target.src = '/aarya_logo.jpeg'; }} />
          <div>
