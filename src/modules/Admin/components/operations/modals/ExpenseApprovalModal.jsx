          ...
          {expense.status === 'Pending' ? (
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-initial px-3.5 sm:px-4 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white text-xs sm:text-sm font-bold shadow-md shadow-rose-500/20 flex items-center justify-center gap-1.5 transition-all"
              >
                <XCircle size={16} />
                Reject
              </button>
              <button
                ...
                className="flex-1 sm:flex-initial px-4 sm:px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold shadow-lg shadow-emerald-500/25 flex items-center justify-center gap-1.5 transition-all hover:translate-y-[-1px]"
              >
