    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.15rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#ffffff', padding: '0.45rem 1rem', borderRadius: '12px', boxShadow: '0 2px 10px rgba(0,0,0,0.08)' }}>
            <img 
              src={logoImg} 
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.45rem' }}>
              <span style={{ fontWeight: '800', fontSize: '1.28rem', letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>
                Aarya Site Expense Management System
              </span>
              <span style={{
