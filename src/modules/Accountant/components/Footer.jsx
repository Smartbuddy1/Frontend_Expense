...
import { ExternalLink, ShieldCheck, FileCheck2, Calculator, PhoneCall, Wallet } from 'lucide-react';
import logoImg from '../assets/ai_logo.jpg';
  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.15rem' }}>
          ...
          <div>
            ...
            <div style={{
              ...
              <span>Site Expense Management & Vendor Disbursals</span>
        ...
        {/* Right: Financial Capabilities Highlights */}
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          alignItems: 'center',
          ...
          <div style={{
            ...
            <FileCheck2 size={14} />
            <span>GST & BOQ Audit Compliant</span>
          </div>
          ...
          <div style={{
            ...
            <Wallet size={14} />
            <span>Direct Vendor Disbursals</span>
          </div>
          ...
          <div style={{
            ...
            <Calculator size={14} />
            <span>Site Reconciliation Engine</span>
          </div>
          ...
          <a
            ...
            title="Click to dial Accounts Helpdesk"
          >
            <PhoneCall size={14} />
            <span>Accounts Support: 9359604384</span>
          </a>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ fontWeight: '500' }}>
          © {currentYear} <strong style={{ color: 'var(--text-primary)', fontWeight: '700' }}>ASEMS - Aarya Site Expense Management System</strong>. All rights reserved.
        </div>
